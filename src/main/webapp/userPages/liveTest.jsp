...
<body>
	...
	<div class="container">
		...
		<div class="question-section">
			<%
			ArrayList<Question> questions = (ArrayList<Question>) session2.getAttribute("question"); // changed wuestions to question
			if (questions == null) {
			...
			<div class="buttons-section">
				...
				<button id="markForReviewButton" style="background-color: #f5b700">Mark
					for Review</button> 
				<button id="submitButton" style="display: none; color: black;">Submit
					Test</button>
			</div>
			<% }
			else { %>
  ...
  document.addEventListener("DOMContentLoaded", function() {
     ...
     // fullscreenModal.classList.remove('hidden');
      ...
      backButton.addEventListener('click', () => {
          window.location.href = "/mind_gauge/UserDashboard";
      });
  ...
  // questions 
    ...
    const questions = [
      <%ArrayList<Question> arr = (ArrayList<Question>) session2.getAttribute("questions");
for (Question question : arr) {%>
    ...
    function submitTestOnTimeout() {
        ...
        if (confirmSubmit) {
            ...
            form.setAttribute('action', '/mind_gauge/Result');
	...
	<div id="fullscreen-modal" class="modal">
		...
		<p>This test requires fullscreen mode to proceed further. Would
			you like to enter fullscreen mode?</p>
		<div class="buttons">
